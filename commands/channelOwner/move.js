...
import {
  ...
  export async function run({
    ...
    server.broadcast({
      ...
      channel: socket.channel, // @todo Multichannel
    }, { channel: socket.channel, level: (level) => level < levels.channelOwner });
  ...
  export const info = {
    ...
    description: 'forces target client(s) into another channel. `nick` may be string or array of strings',
    usage: `
      API: { cmd: 'move', nick: '<target nick>'}`,
  };
